...
UBLOX_ROS::UBLOX_ROS() : Node("ublox_ros") {
    ...
    // TODO(old): implement this chunck of code into ROS2
...
bool UBLOX_ROS::evalF9PID(uint8_t f9pID)
{
    ...
    switch(f9pID)
    {
        ...
        case 1:
            ...
            return false;   // TODO(old): make sure a) this is the correct one to change to false and b) make sure it didn't break anything else
            break;
        default:
            return false;
            break;
