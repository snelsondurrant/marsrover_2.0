...
public:
    ...
    static constexpr int GPS_WEEK_ROLLOVER = 2048; // 10-bit week counter only goes to 1024.  As of Jul 2019, this has rolled over twice /// TODO(old): Make this automatic
