...
class SyncOrigin(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("publish_rate_hz", 1.0)  # in Hz
        publish_rate = (
        ...
        self.publish_timer = self.create_timer(
            self.timer_period, self.publish_origin_callback
        )

        self.get_logger().info(f"SyncOrigin node started. Waiting for first GPS fix...")
