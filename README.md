...
This repository is also configured with a Gemini CLI extension, which you can load by running `gemini` from the root of this repository when Gemini CLI is installed. You can check out the project and get started with it [here](https://github.com/google-gemini/gemini-cli).
