...
>
> <mark>In short, I think there's 100-point potential in this approach and these open-source tools. I'd encourage the 2026 team to mess around with the simulator to understand a bit better how it all works, run some tests on the rover, consider the drawbacks and benefits, and then revisit development on this code base.</mark>
>
