...
#
# Upload the Arduino Mega firmware on the rover
...
# Upload the Arduino Mega firmware on the rover over SSH
ssh -t $ROVER_USERNAME@$ROVER_IP_ADDRESS "cd ~/marsrover_2.0/firmware/mega_pio && bash upload.sh"
