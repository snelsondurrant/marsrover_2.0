...
if [ "$(uname -m)" == "aarch64" ]; then
    ...
    tmux send-keys -t rover_startup.1 "ros2 launch rover_bringup rover_startup.launch.py"  # Enter TODO: Commented out because we don't want this to start until we start using this package
fi
